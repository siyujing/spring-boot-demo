...
//        main_usa();
     ...
     * 消息生成者
     */
    public final static String EXCHANGE_NAME = "myTopicExchangeName1";
    ...
    public static void main_pro() throws IOException, TimeoutException {
        ...
        channel.exchangeDeclare(EXCHANGE_NAME, "topic", true);//声明可持久化交换器
    ...
    public static void main_usa() throws IOException, TimeoutException {
        ...
        //获取一个临时队列
        String queueName = channel.queueDeclare("myQueue2", false, false, false, null).getQueue();
        //接受 USA 信息
        channel.queueBind("myQueue2", EXCHANGE_NAME, "europe.*");
